...
| Use Case                                               | Volume vs Till Receipts | Retention Period                   | Personal Data                                         | OCR-to-hash vs QR code |
|--------------------------------------------------------|-------------------------|------------------------------------|-------------------------------------------------------|--------------------|
| Green cards (I-551 permanent resident cards)            | Medium                  | 10 years (renewal cycle)           | Name, photo, A-number, DOB                            | **OCR-to-hash strong case:** I-9 employment verification; prevents fake green cards; USCIS domain binding. |
| Work visas (H-1B, L-1, O-1, etc.) and I-94 records      | Medium                  | Visa validity period               | Name, visa type, expiration, employer                 | **OCR-to-hash strong case:** I-9 compliance; prevents altered expiration dates; DHS domain binding. |
| Employment Authorization Documents (EAD, I-766)         | Medium                  | 1-2 years (renewal cycle)          | Name, photo, A-number, work authorization dates       | **OCR-to-hash strong case:** I-9 verification; prevents fake EADs; USCIS domain binding. |
...
| Vaccination records and immunization cards        | Medium-Small            | Lifetime (public health)         | Patient name, DOB, vaccine type, lot number, administrator            | **OCR-to-hash strong case:** Wallet card format. Prevents fake vaccination cards. International travel verification. School enrollment. Lifetime records. |
...
| Immigration/border officer verification (checkpoints)      | Medium                  | Encounter + 1-3 years               | Officer name, photo, badge number, agency, checkpoint location                     | **OCR-to-hash strong case:** Traveler verifies immigration officer, customs officer, border patrol agent credentials at checkpoint or immigration encounter. Domain binding verifies government agency (cbp.gov, immigration.gov, border-agency.gov). Real-time verification shows officer photo, badge number, agency affiliation. Prevents fake immigration officer scams (criminals impersonating officers for extortion, document theft). Critical for immigrants, travelers - protects against fraud and enhances accountability. |
...
- **Fake immigration officer extortion:** Criminals impersonate immigration officials to extort money from immigrants, threaten deportation unless "fines" paid immediately (common fraud in immigrant communities)
...
- **USA:** State professional licensing boards (nursing, childcare, real estate), background check requirements (FCRA), sector-specific regulations, Law enforcement identification standards, Building code enforcement credentials, Federal inspector credentials (USPS, CBP, immigration)
