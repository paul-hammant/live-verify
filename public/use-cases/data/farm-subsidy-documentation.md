...
<div style="max-width: 600px; margin: 24px auto; font-family: sans-serif; border: 1px solid #ccc; background: #fff; padding: 0; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
  <div style="background: #1b5e20; color: #fff; padding: 20px; display: flex; justify-content: space-between; align-items: center;">
    <div>
      <div style="font-weight: bold; font-size: 1.1em;" verifiable-text="start" data-for="subsidy">U.S. DEPARTMENT OF AGRICULTURE</div>
...
<div style="font-size: 0.9em; line-height: 1.6; color: #333;">
      <p><strong>Producer:</strong> <span>[</span>Miller Family Farms, Inc.<br>
