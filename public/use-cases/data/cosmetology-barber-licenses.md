...
<div style="max-width: 400px; margin: 24px auto; font-family: sans-serif; border: 4px solid #333; background: #fff; padding: 0; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
  <div style="background: #333; color: #fff; padding: 15px; text-align: center;">
    <h2 style="margin: 0; text-transform: uppercase; letter-spacing: 1px;" verifiable-text="start" data-for="beauty">STATE BOARD OF COSMETOLOGY</h2>
...
<div style="padding: 25px; display: flex;">
    ...
    <div style="flex-grow: 1;">
      ...
      <div style="font-size: 1.2em; font-weight: bold; margin: 5px 0;"><span>[</span>JANE STYLIST-DOE</div>
