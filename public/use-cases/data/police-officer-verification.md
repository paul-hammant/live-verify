...
<div style="max-width: 400px; margin: 24px auto; font-family: sans-serif; border: 2px solid #002d62; border-radius: 12px; background: #fff; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
  <div style="background: #002d62; color: #fff; padding: 15px; display: flex; align-items: center; justify-content: space-between;">
    ...
    <div style="text-align: right;">
      <div style="font-weight: bold; font-size: 1.1em; letter-spacing: 1px;" verifiable-text="start" data-for="police">WARRANT CARD</div>
...
<div style="padding: 20px; display: flex;">
    ...
    <div style="flex-grow: 1;">
      <div style="font-size: 1.4em; font-weight: bold; margin: 0 0 10px 0; color: #002d62;"><span>[</span>PC Alex D 1332</div>
...
<div style="max-width: 320px; margin: 24px auto; font-family: 'Courier New', monospace; border: 3px solid #002d62; border-radius: 8px; background: #f5f5f0; padding: 20px; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
  <div style="font-size: 1em; color: #000; font-weight: bold; margin-bottom: 8px;"><span>[</span>METROPOLITAN POLICE</div>
  <div style="font-size: 1em; color: #000;<div style="font-size: 1em; color: #000; margin-bottom: 8px;" verifiable-text="start" data-for="eink">"font-size: 1em; font-weight: bold; color: #000; margin-bottom: 8px;">PC Alex D 1332</div>
...
<div style="max-width: 570px; margin: 24px auto; border: 12px solid #333; border-radius: 30px; background: #fff; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.3); display: flex; flex-direction: row;">
  ...
  <div style="flex-grow: 1; padding: 20px; font-family: sans-serif; text-align: left; background: #fff;">
    <div style="font-size: 1.2em; color: #000; font-weight: bold; margin-bottom: 5px;"><span>[</span>METROPOLITAN POLICE</div>
    <div style="font-size: 1.2em; color: #000; mar<div style="font-size: 1.2em; color: #000; margin-bottom: 15px; letter-spacing: 1px;" verifiable-text="start" data-for="app-police">t-size: 1.2em; font-weight: bold; color: #000; margin-bottom: 5px;">PC Alex D 1332</div>
