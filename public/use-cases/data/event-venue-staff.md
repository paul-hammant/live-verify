...
<div style="max-width: 320px; margin: 24px auto; font-family: 'Courier New', monospace; border: 4px solid #000; border-radius: 4px; background: #f0f0f0; padding: 20px; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
  <div style="font-size: 1.2em; color: #000; font-weight: 900; margin-bottom: 8px;"><span>[</span>COACHELLA</div>
  <div style="font-size: 1em; font-weight: bold<div style="font-size: 1em; font-weight: bold; color: #000; margin-bottom: 8px;" verifiable-text="start" data-for="eink-crew">olor: #333; margin-bottom: 8px;">Stage Crew - Zone A</div>
