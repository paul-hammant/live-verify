...
<div style="max-width: 600px; margin: 24px auto; font-family: 'Times New Roman', serif; border: 1px solid #ccc; background: #fff; padding: 40px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
  <div style="text-align: center; margin-bottom: 30px;">
    <div style="font-weight: bold; font-size: 1.2em; text-transform: uppercase;" verifiable-text="start" data-for="custody">In the Circuit Court of Cook County, Illinois</div>
...
<div style="font-size: 0.95em; line-height: 1.6; text-align: justify;">
    ...
    <p>1. The parties have agreed to a Parenting Plan regarding the minor child, <span>[</span><strong>MICHAEL DOE (DOB: 05/12/2018)</strong>.</p>
