...
<div style="max-width: 600px; margin: 24px auto; font-family: 'Times New Roman', Georgia, serif; border: 1px solid #999; background: #fff; padding: 40px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
  <div style="text-align: center; border-bottom: 2px solid #000; padding-bottom: 10px; margin-bottom: 25px;">
    <div style="font-weight: bold; font-size: 1.2em;" verifiable-text="start" data-for="condo">PREMIER PROPERTY MANAGEMENT, LLC</div>
...
<div style="font-size: 0.95em; line-height: 1.6; color: #333;">
    <p><strong>Association:</strong> <span>[</span>Skyline Towers Condominium Association<br>
