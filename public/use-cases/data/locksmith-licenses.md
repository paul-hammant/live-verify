...
<div style="max-width: 400px; margin: 24px auto; font-family: sans-serif; border: 2px solid #333; border-radius: 12px; background: #fff; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
  <div style="background: #333; color: #fff; padding: 15px; text-align: center; display: flex; align-items: center; justify-content: center;">
    ...
    <div>
      <h3 style="margin: 0; text-transform: uppercase; letter-spacing: 1px;" verifiable-text="start" data-for="locksmith">STATE OF CALIFORNIA</h3>
...
<div style="padding: 20px; display: flex;">
    ...
    <div style="flex-grow: 1;">
      ...
      <div style="font-size: 1.1em; font-weight: bold; margin: 5px 0;"><span>[</span>ROBERT J. MILLER</div>
...
<div style="padding: 0 20px 20px 20px;">
    ...
    <div data-verify-line="locksmith" style="border-top: 1px dashed #999; margin-top: 10px; padding-top: 5px; font-family: 'Courier New', monospace; font-size: 0.75em; color: #555; text-align: center;"
      ...
      verify:bsis.ca.gov/v/992288 <span verifiable-text="end" data-for="locksmith">]</span>
    </div>
  </div>
</div>
