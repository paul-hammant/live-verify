...
<div style="max-width: 500px; margin: 24px auto; font-family: 'Times New Roman', serif; border: 4px solid #000; background: #fff; padding: 30px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); position: relative;">
  <div style="text-align: center; border-bottom: 2px solid #000; padding-bottom: 15px; margin-bottom: 20px;">
    <div style="font-weight: bold; font-size: 1.3em; text-transform: uppercase;" verifiable-text="start" data-for="elevator">Department of Buildings</div>
...
<div style="font-size: 0.9em; line-height: 1.6;">
    ...
    <strong>Device ID:</strong> <span>[</span>ELV-992288-B (Car #2)<br>
